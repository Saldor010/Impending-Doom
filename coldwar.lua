...
local function ContextPopUp(context)
	...
	if context["button1"] then
		...
		ContextPopUpLabel1.state = "_ALL"
		ContextPopUpButton1.state = "_ALL"
		ContextPopUpHelp1.state = "_ALL"
	else
	...
	if context["button2"] then
		...
		ContextPopUpLabel2.state = "_ALL"
		ContextPopUpButton2.state = "_ALL"
		ContextPopUpHelp2.state = "_ALL"
	else
	...
	if context["button3"] then
		...
		ContextPopUpLabel3.state = "_ALL"
		ContextPopUpButton3.state = "_ALL"
		ContextPopUpHelp3.state = "_ALL"
	else
	...
	if context["button4"] then
		...
		ContextPopUpLabel4.state = "_ALL"
		ContextPopUpButton4.state = "_ALL"
		ContextPopUpHelp4.state = "_ALL"
	else
	...
	["Enemy"] = { -- Clicking on enemy cities
		[1] = {
			...
			["Function"] = function(cityName,city)
				...
				Alert("Select a friendly city to fire from.",nations[nationSelectedForPlaying]["Color"])
